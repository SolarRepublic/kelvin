...
const kitchen_sink: SchemaBuilder = (k: PartableSchemaSpecifier, xc_cat: Category, s_id: string) => ({
	...
	obj: k.obj(),
	// ref: k.ref(),
	arr_int: k.array(k1 => k1.int()),
	arr_bigint: k.array(k1 => k1.bigint()),
	arr_double: k.array(k1 => k1.double()),
	arr_str: k.array(k1 => k1.str()),
	arr_bytes: k.array(k1 => k1.bytes()),
	arr_obj: k.array(k1 => k1.obj()),
	arr_arr_str: k.array(k1 => k1.array(k2 => k2.str())),
	arr_arr_arr_str: k.array(k1 => k1.array(k2 => k2.array(k3 => k3.str()))),
	tuple_int: k.tuple(k1 => [k1.int()]),
	tuple_int_str: k.tuple(k1 => [k1.int(), k1.str()]),
	tuple_int_str_arr_bytes: k.tuple(k1 => [k1.int(), k1.str(), k1.array(k2 => k2.bytes())]),
	struct: k.struct(k1 => ({
		int: k1.int(),
		bigint: k1.bigint(),
		double: k1.double(),
